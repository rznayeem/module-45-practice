  ...
  return (
    <div className="p-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-4 my-10 flex flex-col justify-center items-center mx-auto bg-white">
      ...
      <div className="text-center space-y-1">
        <h1 className="text-2xl text-gray-700">{user.username}</h1>
      ...
      <Link to={`/user/${user.id}`}>
        <button className="hover:bg-[#0095FF] hover:scale-95 font-medium hover:text-white w-full py-2 rounded-full hover:shadow-xl px-10   text-gray-400 shadow-[0px_0px_10px_#E2DADA] t duration-500">
          View Profile
        </button>
      </Link>
    </div>
